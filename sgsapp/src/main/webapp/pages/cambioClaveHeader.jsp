                    ...
                    <center>
                        <rich:panel id="pnl" header="CAMBIO DE CLAVE" style="font-size: 13px;width: 350px;text-align: left;" >
                            ...
                            <h:panelGrid columns="1" width="100%" style="text-align: center;">
                                <h:panelGroup>
                                    <h:commandButton value="Registrar" action="#{claveMB.cambioClave}" style="font-size: 11px;height: 2em"  />
                                    <h:commandButton value="Cancelar" action="bienvenida" style="font-size: 11px;height: 2em" />
                                </h:panelGroup>
                            </h:panelGrid>
                        </rich:panel>
                    </center>
