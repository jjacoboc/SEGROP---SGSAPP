...
<html>
    <head>
        ...
        <title>SGSWEB - Anulación de Documentos</title>
    ...
    <body>
        <f:view>
            ...
            <h:form id="documentoForm">
                <rich:panel id="pnlDocumento" header="ANULACIÓN DE DOCUMENTOS" style="font-size: 13px;">
                    <fieldset>
                    ...
                    <fieldset>
                        ...
                        <rich:dataTable id="tbl" var="row" value="#{documentoMB.listaDocumento}" rows="10" rowKeyVar="rowKey" style="font-size: 11px;" width="100%">
                            ...
                            <rich:column style="text-align: center;width: 8%;">
                                ...
                                <rich:spacer width="5"/>
                                <a4j:commandLink id="dellink">
                                    <f:setPropertyActionListener value="#{row}" target="#{documentoMB.selectedDocument}"/>
                                    <rich:componentControl for="deldlg" attachTo="dellink" operation="show" event="onclick"/>
                                    <h:graphicImage style="border: 0;" url="/pages/images/cross.png" alt="eliminar documento" title="eliminar documento"/>
                                </a4j:commandLink>
                            </rich:column>
                        </rich:dataTable>
                    </fieldset>
            ...
            <rich:modalPanel id="deldlg" height="150" keepVisualState="true" resizeable="false">
                <f:facet name="header">
                    <h:outputText value="Eliminación del Documento"></h:outputText>
                </f:facet>
                <h:form id="mdForm">
                    <h:graphicImage style="border: 0;" url="/pages/images/messagebox_warning.png"/><rich:spacer width="5"/>
                    <h:outputText value="Advertencia!" style="font-weight: bold;"/><br>
                    <h:outputText value="El documento será eliminado de forma definitiva y" style="font-weight: bold;"/><br>
                    <h:outputText value="no podrá ser recuperado nuevamente." style="font-weight: bold;"/><br>
                    <h:outputText value="Se procederá a eliminar el documento."/><br>
                    <h:outputText value="Desea Continuar?"/><br>
                    <hr>
                    <a4j:commandButton id="dbtnSI" value="SI" reRender="tbl" actionListener="#{documentoMB.eliminarDocumento}" status="commonstatus" style="font-size: 11px;height: 2em">
