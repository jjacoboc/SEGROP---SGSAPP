        ...
        <f:view>
            ...
            <rich:modalPanel id="confirmDlg" height="100" keepVisualState="true" resizeable="false">
                ...
                <h:form id="confirmDlgForm">
                    <h:outputText value="Se procederá a registrar el lugar." style="font-size: 11px;"/><br/>
            ...
            <rich:modalPanel id="confirmEditDlg" height="100" keepVisualState="true" resizeable="false">
                ...
                <h:form id="confirmEditDlgForm">
                    <h:outputText value="Se procederá a editar el lugar." style="font-size: 11px;"/><br/>
                    <h:outputText value="Desea Continuar?" style="font-size: 11px;"/><br/>
                    <hr>
            ...
            <rich:modalPanel id="cdlg" height="100" keepVisualState="true" resizeable="false">
                <f:facet name="header">
                    <h:outputText value="Desactivación del Lugar"></h:outputText>
                </f:facet>
                <h:form id="mpdForm">
                    <h:outputText value="Se procederá a desactivar el lugar."/><br/>
            ...
            <rich:modalPanel id="cadlg" height="100" keepVisualState="true" resizeable="false">
                <f:facet name="header">
                    <h:outputText value="Activación del Lugar"></h:outputText>
                </f:facet>
                <h:form id="mpaForm">
                    <h:outputText value="Se procederá a activar el lugar."/><br/>
                    <h:outputText value="Desea Continuar?"/><br/>
                    <hr>
