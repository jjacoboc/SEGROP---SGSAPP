...
/**
 * SegDetLocalId generated by hbm2java
 */
public class SegDetLocalId implements java.io.Serializable {

    private BigDecimal NCodLocal;
    private BigDecimal NCodEmpresa;

    public SegDetLocalId() {
        super();
    }

    public SegDetLocalId(BigDecimal NCodLocal, BigDecimal NCodEmpresa) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SegDetLocalId)) {
            return false;
        }
        SegDetLocalId castOther = (SegDetLocalId) other;

        return ((this.getNCodLocal() == castOther.getNCodLocal()) || (this.getNCodLocal() != null && castOther.getNCodLocal() != null && this.getNCodLocal().equals(castOther.getNCodLocal())))
