 ...
 */
public class SegDetExportdetalleId implements java.io.Serializable {

    private BigDecimal NCodEmpresa;
    private BigDecimal NCodExport;
    private BigDecimal NCodExportDetalle;

    public SegDetExportdetalleId() {
        super();
    }

    public SegDetExportdetalleId(BigDecimal NCodEmpresa, BigDecimal NCodExport, BigDecimal NCodExportDetalle) {
        this.NCodEmpresa = NCodEmpresa;
        this.NCodExport = NCodExport;
        this.NCodExportDetalle = NCodExportDetalle;
    }
    ...
    public BigDecimal getNCodExportDetalle() {
        return this.NCodExportDetalle;
    }

    public void setNCodExportDetalle(BigDecimal NCodExportDetalle) {
        this.NCodExportDetalle = NCodExportDetalle;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SegDetExportdetalleId)) {
            return false;
        }
        SegDetExportdetalleId castOther = (SegDetExportdetalleId) other;
        ...
        return ((this.getNCodEmpresa() == castOther.getNCodEmpresa()) || (this.getNCodEmpresa() != null && castOther.getNCodEmpresa() != null && this.getNCodEmpresa().equals(castOther.getNCodEmpresa())))
                ...
                && ((this.getNCodExportDetalle() == castOther.getNCodExportDetalle()) || (this.getNCodExportDetalle() != null && castOther.getNCodExportDetalle() != null && this.getNCodExportDetalle().equals(castOther.getNCodExportDetalle())));
    }
    ...
    public int hashCode() {
        ...
        result = 37 * result + (getNCodExportDetalle() == null ? 0 : this.getNCodExportDetalle().hashCode());
        return result;
    }
}
