...
/**
 * SegDetInsPresencial generated by hbm2java
 */
public class SegDetInsPresencial implements java.io.Serializable {

    private SegDetInsPresencialId id;
    ...
    private BigDecimal NTipoInspeccion;
    ...
    private BigDecimal NCumpleControl;
    private BigDecimal NControlAdicional;
    ...
    private String VControlAdicional;
    private BigDecimal NAnalisis;
    private BigDecimal NSeguimiento;
    private BigDecimal NEstado;
    private Set<SegDetInspreEvaluacion> segDetInspreEvaluacions = new HashSet<SegDetInspreEvaluacion>(0);
    private Set<SegDetInspreAcciones> segDetInspreAccioneses = new HashSet<SegDetInspreAcciones>(0);

    public SegDetInsPresencial() {
        super();
    }

    public SegDetInsPresencial(SegDetInsPresencialId id) {
        this.id = id;
    }

    public SegDetInsPresencial(SegDetInsPresencialId id, BigDecimal NCodInspresencial, BigDecimal NCodEmpresa, BigDecimal NPersona, BigDecimal NActivo, BigDecimal NProceso, BigDecimal NTipoInspeccion, BigDecimal NCodNovedad, Date DFecHora, String VDescBreve, String VDescripcion, BigDecimal NLocal, BigDecimal NArea, BigDecimal NLugar, BigDecimal NResponsable, BigDecimal NCargo, String VAccTomadas, BigDecimal NCumpleControl, BigDecimal NControlAdicional, String VUsuCreacion, Date DFecCreacion, String VIpCreacion, String VUsuModificacion, Date DFecModificacion, String VIpModificacion, String VControlAdicional, BigDecimal NAnalisis, BigDecimal NSeguimiento, BigDecimal NEstado, Set<SegDetInspreEvaluacion> segDetInspreEvaluacions, Set<SegDetInspreAcciones> segDetInspreAccioneses) {
        this.id = id;
        ...
        this.NTipoInspeccion = NTipoInspeccion;
        ...
        this.NCumpleControl = NCumpleControl;
        this.NControlAdicional = NControlAdicional;
        ...
        this.VControlAdicional = VControlAdicional;
        this.NAnalisis = NAnalisis;
        this.NSeguimiento = NSeguimiento;
        this.NEstado = NEstado;
        this.segDetInspreEvaluacions = segDetInspreEvaluacions;
        this.segDetInspreAccioneses = segDetInspreAccioneses;
    }

    public SegDetInsPresencialId getId() {
        return this.id;
    }

    public void setId(SegDetInsPresencialId id) {
        this.id = id;
    }
    ...
    public BigDecimal getNTipoInspeccion() {
        return this.NTipoInspeccion;
    }

    public void setNTipoInspeccion(BigDecimal NTipoInspeccion) {
        this.NTipoInspeccion = NTipoInspeccion;
    }
    ...
    public BigDecimal getNCumpleControl() {
        return this.NCumpleControl;
    }

    public void setNCumpleControl(BigDecimal NCumpleControl) {
        this.NCumpleControl = NCumpleControl;
    }

    public BigDecimal getNControlAdicional() {
        return this.NControlAdicional;
    }

    public void setNControlAdicional(BigDecimal NControlAdicional) {
        this.NControlAdicional = NControlAdicional;
    }
    ...
    public String getVControlAdicional() {
        return this.VControlAdicional;
    }

    public void setVControlAdicional(String VControlAdicional) {
        this.VControlAdicional = VControlAdicional;
    }
    ...
    public Set<SegDetInspreEvaluacion> getSegDetInspreEvaluacions() {
        return this.segDetInspreEvaluacions;
    }

    public void setSegDetInspreEvaluacions(Set<SegDetInspreEvaluacion> segDetInspreEvaluacions) {
        this.segDetInspreEvaluacions = segDetInspreEvaluacions;
    }

    public Set<SegDetInspreAcciones> getSegDetInspreAccioneses() {
        return this.segDetInspreAccioneses;
    }

    public void setSegDetInspreAccioneses(Set<SegDetInspreAcciones> segDetInspreAccioneses) {
        this.segDetInspreAccioneses = segDetInspreAccioneses;
    }
}
