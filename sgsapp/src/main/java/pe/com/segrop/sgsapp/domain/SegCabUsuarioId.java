...
/**
 * SegCabUsuarioId generated by hbm2java
 */
public class SegCabUsuarioId implements java.io.Serializable {

    private BigDecimal NCodUsuario;
    private BigDecimal NCodEmpresa;

    public SegCabUsuarioId() {
        super();
    }

    public SegCabUsuarioId(BigDecimal NCodUsuario, BigDecimal NCodEmpresa) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SegCabUsuarioId)) {
            return false;
        }
        SegCabUsuarioId castOther = (SegCabUsuarioId) other;
