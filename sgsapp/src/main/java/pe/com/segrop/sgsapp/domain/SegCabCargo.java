 ...
 */
public class SegCabCargo implements java.io.Serializable {
    ...
    public SegCabCargo(BigDecimal NCodCargo) {
        this.NCodCargo = NCodCargo;
    }

    public SegCabCargo(BigDecimal NCodCargo, String VDescripcion, BigDecimal NFlgActivo, String VUsuCreacion, Date DFecCreacion, String VIpCreacion, String VUsuModificacion, Date DFecModificacion, String VIpModificacion, Set<SegDetInsTelefonica> segDetInsTelefonicas) {
        this.NCodCargo = NCodCargo;
